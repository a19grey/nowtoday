  ...
  useEffect(() => {
    const checkUserDomain = async () => {
      if (user) {
        ...
        if (email && (email.endsWith('@gmail.com') || email.endsWith('@tracevision.com'))) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 font-mono relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200 opacity-50" style={{
        backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%239C92AC' fill-opacity='0.05'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")"
      }} />
