...
def refine_content(raw_content):
     ...
     if os.path.exists('backend/script.md'):
        print("script.md found. Skipping content refinement.")
        with open('backend/script.md', 'r') as f:
        ...
        with open('backend/summary.md', 'w') as f:
            f.write(summary)
        ...
        # Save script to file
        with open('backend/script.md', 'w') as f:
            f.write(script)
        ...
        with open('backend/final_script.md', 'w') as f:
